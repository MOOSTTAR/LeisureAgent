  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-slate-50/50">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-6 z-40 flex items-center gap-3 px-7 py-4 bg-white rounded-xl border border-slate-200/50 shadow-[0_4px_16px_-4px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.15)] transition-shadow text-lg text-slate-600 hover:text-slate-900"
      >
